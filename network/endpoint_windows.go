...
func (nw *network) newEndpointImpl(cli apipaClient, _ netlink.NetlinkInterface, _ platform.ExecClient, epClient EndpointClient, epInfo *EndpointInfo) (*endpoint, error) {
...
func (nw *network) deleteEndpointImpl(_ netlink.NetlinkInterface, _ platform.ExecClient, epClient EndpointClient, ep *endpoint) error {
